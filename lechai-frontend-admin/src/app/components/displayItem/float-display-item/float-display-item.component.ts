...
@Component({
  selector: 'app-float-display-item',
  templateUrl: './float-display-item.component.html',
  styleUrls: ['./float-display-item.component.scss']
})
export class FloatDisplayItemComponent implements OnInit, DisplayItemTemplate{
